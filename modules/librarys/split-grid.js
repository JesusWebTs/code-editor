...
(function(global, factory) {
    ...
    Gutter.prototype.getRawTracks = function getRawTracks() {
        var tracks = getStyles(
            this.gridTemplateProp, [this.grid],
    ...
    var createGutter = function(direction, options) {
        return function(gutterOptions) {
            ...
            var trackMinSizes =
                ...
                options.rowMinSizes || {};
            var trackMinSize =
                direction === "column" ? "columnMinSize" : "rowMinSize";
    ...
    Grid.prototype.removeColumnGutter = function removeColumnGutter(
        track,
        immediate
    ) {
        var this$1 = this;
    ...
    Grid.prototype.handleDragStart = function handleDragStart(
        e,
        direction,
        track
    ) {
